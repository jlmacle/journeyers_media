...
<hr>
<br>
You might have to modify the settings to be able to install the app.
<hr>
Il est possible que vous ayez à modifier les paramètres pour installer l'application.